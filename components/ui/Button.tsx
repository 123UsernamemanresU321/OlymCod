...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  return (
    <button
      ref={ref}
      className={cn(
        "inline-flex items-center justify-center gap-2 rounded border font-medium tracking-[0.04em] transition-colors focus:outline-none focus:ring-2 focus:ring-[#2c5282] focus:ring-offset-2",
